...
<div class="row mt-2">
    <div class="col-md-5 offset-md-4">
        ...
        <form action="{{ route('admin/storeTask') }}" method="post">
            ...
            <input type="text" name="taskTitle" id="taskTitle" placeholder="Task Title" value="{{ old('taskTitle') }}" class="form-control form-control-sm">
            ...
            <textarea name="taskDesc" id="taskDesc" cols="30" rows="5" value="{{ old('taskDesc') }}" class="form-control form-control-sm" placeholder="Task Description"></textarea>
            ...
            <input type="text" onfocus="(this.type='date')" onblur="(this.type='text')" name="assignDate" value="{{ old('assignDate') }}" id="assignDate" class="form-control form-control-sm" placeholder="dd-mm-yyyy">
            @if($errors->any())
