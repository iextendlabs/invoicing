            ...
            <form action="{{ route('admin/project/created') }}" method="post">
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <input type="text" name="project_name" class="form-control form-control-sm"
                            value="{{ old('project_name') }}" placeholder="Name   ( minimum 5 characters )">
                ...
                <div class="row">
                    <div class="col mt-2">
                        ...
                        <textarea class="form-control form-control-sm" name="project_desc" value="{{ old('project_desc') }}"
                            placeholder="description   ( minimum 10 characters )"></textarea>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col mt-2">
                        ...
                        <input type="number" name="project_rate" class="form-control form-control-sm"
                            value="{{ old('project_rate') }}" id="prate" placeholder="Enter Project Rate">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col mt-2">
                        ...
                        <input type="number" name="per_hour_rate" class="form-control form-control-sm"
                            value="{{ old('per_hour_rate') }}" id="prate" placeholder="Enter Hour Rate">
                    </div>
                </div>
